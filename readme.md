...
> `remote/submodules/live-mutex.distributed` — make changes here, not in that submodule checkout.
>
> On disk: source clone `~/codes/ores/live-mutex.distributed` · submodule checkout `~/codes/ores/k8s-cluster/remote/submodules/live-mutex.distributed`.
